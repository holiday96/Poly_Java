...
public class StudentRegistration extends JFrame implements ActionListener{
	...
	private JTextField txtFirstName, txtLastName, txtContact, txtHigh, txtSpecification, txtEnroll, txtHobbies, txtSport;
	...
	private void initializer() {
		...
		pnlPersonal.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Personal Detail", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		pnlAcamedic.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Acamedic Details", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		pnlExtracurricular.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Extracurricular Details", TitledBorder.LEADING, TitledBorder.TOP, null, null));
