...
<c:if test="${empty result }">
	<form action="<c:url value='/lab/2/bai3' />" method="post" id="register">
	    <h1>Đăng Ký</h1>
        ...
        <input type="checkbox" name="hobbies" id="read" value="R"><label for="read">Đọc sách</label>
        <input type="checkbox" name="hobbies" id="travel" value="T"><label for="travel">Du lịch</label>
        <input type="checkbox" name="hobbies" id="music" value="M"><label for="music">Âm nhạc</label>
        <input type="checkbox" name="hobbies" id="other" value="O"><label for="other">Khác</label><br>
