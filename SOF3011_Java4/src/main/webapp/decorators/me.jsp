...
<head>
    ...
    <!-- Styles -->
    <link rel='stylesheet' href="<c:url value='/templates/me/me.css' /> " type='text/css' media='screen' />
    ...
    <div class="fs-me">
        ...
        <div class="me-content">
            ...
            <div class="network">
                <ul>
                    <li>
                        <a class="icon-twitter" href="https://twitter.com/xucxichduc96">
                    ...
                    <li>
                        <a class="icon-instagram" href="https://www.instagram.com/vietduc.bui/">
                            <svg class="svg-icon" viewBox="0 0 20 20">
                    ...
                    <li>
                        <a class="icon-pinterest" href="https://www.pinterest.com/xushita96/">
                            <svg class="svg-icon" viewBox="0 0 20 20">
                    ...
                    <li>
                        <a class="icon-facebook" href="https://www.facebook.com/LwLViDu/">
                            <svg class="svg-icon" viewBox="0 0 20 20">
                    ...
                    <li>
                        <a class="icon-youtube" href="https://www.youtube.com/channel/UC0lN_Y9euk9q5W3eU9syZ4Q">
                            <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <div class="credit">
                <p class="copyright">&copy;2021 <a href="#">XuShiTa</a> - Home Page by me</p>
            </div>
        </div>
    </div>
</body>
